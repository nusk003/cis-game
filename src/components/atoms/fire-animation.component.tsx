...
const SFlameMainOne = styled.path`
  animation-duration: 4s;
  animation-delay: 1s;
`;

const SFlameMainTwo = styled.path`
  animation-duration: 3s;
  animation-delay: 2s;
`;

const SFlameMainThree = styled.path`
  animation-duration: 2.1s;
  animation-delay: 3s;
`;

const SFlameMainFour = styled.path`
  animation-duration: 3.2s;
  animation-delay: 4s;
`;

const SFlameMainFive = styled.path`
  animation-duration: 2.5s;
  animation-delay: 5s;
`;

const SFlameOne = styled.path`
  animation-delay: 1s;
  animation-duration: 3s;
`;

const SFlameTwo = styled.path`
  animation-duration: 5s;
  animation-delay: 1s;
`;

const SFlame = styled.path`
